...
RUN apt-get update && apt-get install -y --no-install-recommends python-is-python3 python3-gi pkg-config libcairo2-dev gcc python3-dev libgirepository1.0-dev
